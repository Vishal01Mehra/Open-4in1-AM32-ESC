...
| Rev | Date | Change |
|---|---|---|
| Rev3.3 | 2026-08-25 | Export `OpenESC-20x20-rev3.3`, current. Silkscreen rebranded OpenDrone -> incutec; rev text now synced by the export pipeline. Bulk bank moved from 22 x 10 uF (Samsung CL31B106KBHNNNE, C89632) to 22 x 4.7 uF 50 V X7R 1206 (CCTC TCC1206X7R475K500HT, C380366; was FH C29823 until 2026-08-26, swapped for LCSC retail price after the move off JLCPCB assembly). 57 anchoring vias added on the motor phase pours (waived as via_dangling in the release baseline). |
